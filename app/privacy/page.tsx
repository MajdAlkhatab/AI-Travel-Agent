    ...
    <div className="max-w-3xl mx-auto px-6 py-16 bg-white text-black font-sans">
      ...
      <div className="space-y-8 leading-relaxed">
        <section>
          ...
          <p>Welcome to TripHunter. We respect your privacy and are committed to protecting any personal data you may share with us. This Privacy Policy explains how we collect, use, and safeguard information when you use our website and automated travel deal services.</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">2. Information We Collect</h2>
          <p>TripHunter operates primarily as an automated travel deal aggregator and social media publisher.</p>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            <li>Maintain and improve the TripHunter platform.</li>
        ...
        <section>
          ...
          <p>If you have any questions about this Privacy Policy, please contact us by sending a direct message to our official TikTok account at <strong>@triphunter4</strong>.</p>
        </section>
      </div>
    </div>
  );
