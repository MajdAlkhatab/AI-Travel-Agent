                  ...
                  <div className="relative h-44 overflow-hidden bg-gradient-to-br from-slate-700 to-slate-900">
                    ...
                    {econ.hasSavings ? (
                      <div className="absolute top-12 right-4 z-10 flex flex-col items-end">
                        {/* 1. Procentuell Rabatt (Oförändrad storlek och position) */}
                        {econ.totalSavingsPercent != null && (
                        ...
                        {/* 2. Huvudkortet (Vit box) med relativ positionering */}
                        <div className="bg-white/30 backdrop-blur-md rounded-xl pt-2.5 pb-3.5 px-3 shadow-xl border border-white/40 flex flex-col items-end z-10 relative">
                          ...
                          {/* 3. Gröna rutan - Överlappar botten och sticker ut till vänster */}
                          <div className="absolute -bottom-3 right-3 bg-emerald-400/15 backdrop-blur-md text-emerald-950 text-[11px] font-extrabold pl-4 pr-2 py-1 rounded-md border border-emerald-300/30 drop-shadow-sm shadow-sm whitespace-nowrap z-20">
                            Du sparar {formatPrice(econ.totalSavings!, displayCurrency, latestRates)}
                          </div>
                        </div>
                      </div>
                    ) : econ.totalCurrent != null ? (
                      <div className="absolute top-14 right-4 z-10 bg-white/30 backdrop-blur-md rounded-xl pt-2.5 pb-3 px-3 shadow-xl border border-white/40 flex flex-col items-end">
                        <div className="text-[9px] text-gray-900 uppercase tracking-widest font-extrabold mb-0.5 drop-shadow-md">
                          Totalt pris
                        </div>
                        <div className="text-2xl font-black text-gray-900 leading-none drop-shadow-md">
